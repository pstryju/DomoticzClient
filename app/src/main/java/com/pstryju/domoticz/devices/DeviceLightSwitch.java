...
public class DeviceLightSwitch extends Device {
    private boolean state;
    private final String baseURL = "http://pstryju.ddns.net/json.htm?type=command&param=switchlight&idx=" + idx + "&";
    private String URL;

    public DeviceLightSwitch(String idx, String name, String state, Context context, DevicesAdapter devicesAdapter) {
        super(idx, name);
        mContext = context;
